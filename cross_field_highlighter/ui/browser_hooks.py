...
from aqt import gui_hooks, QMenu, DialogManager
...
class BrowserHooks:
    ...
    def __on_event(self, browser: Browser, menu: QMenu) -> None:
        ...
        browser_menu: BrowserMenu = BrowserMenu(
            browser, self.__op_factory, self.__adhoc_highlight_dialog_controller, self.__adhoc_erase_dialog_controller,
            self.__dialog_params_factory, self.__addon_manager, self.__dialog_manager, self.__config, self.__settings)
