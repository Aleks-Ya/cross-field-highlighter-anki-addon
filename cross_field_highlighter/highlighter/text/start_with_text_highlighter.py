...
class StartWithTextHighlighter(TextHighlighter):
    ...
    def highlight(self, collocation: str, text: str, stop_words: set[str], highlight_format: HighlightFormat) -> Text:
        ...
        return Text(re.sub(fr'((?<!<b>)(?<!<)(?<!</)\b{base_collocation}\b(?<!>)(?<!</b>))', r'<b>\1</b>', text,
                      flags=re.IGNORECASE))
