...
def test_show_view(adhoc_highlight_dialog_view: AdhocHighlightDialogView,
    ...
    exp_default_stop_words: Text = Text("a an")
...
def test_bug_duplicate_formats_after_reopening(note_type_details_all: list[NoteTypeDetails],
    ...
    adhoc_highlight_dialog_model.fill(note_type_details_all, note_type_details_all, 3, all_highlight_formats,
                                      Text(DefaultConfig.default_stop_words), None, None)
