...
def test_update_config(adhoc_erase_dialog_controller: AdhocEraseDialogController,
    ...
    # Update again
    adhoc_erase_dialog_model.switch_state(note_type_details_cloze.note_type_id)
...
def test_remember_state_on_cancel_click(adhoc_erase_dialog_controller: AdhocEraseDialogController,
                                        adhoc_erase_dialog_model: AdhocEraseDialogModel,
...
def test_remember_state_on_cancel_esc_shortcut(adhoc_erase_dialog_controller: AdhocEraseDialogController,
                                               adhoc_erase_dialog_model: AdhocEraseDialogModel,
                                               adhoc_erase_dialog_view: AdhocEraseDialogView,
                                               config_loader: ConfigLoader,
                                               note_type_details_basic: NoteTypeDetails,
    ...
    # Click Cancel
    adhoc_erase_dialog_view_scaffold.press_esc()
    assert config_loader.load_config() == DefaultConfig.loader
    assert adhoc_erase_dialog_model.as_dict() == {
        'all_note_types': note_type_details_all,
        'accept_callback_None': False,
