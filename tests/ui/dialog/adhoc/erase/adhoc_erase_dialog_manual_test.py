...
def test_show_erase_dialog(adhoc_erase_dialog_controller: AdhocEraseDialogController,
                           ...
                           td: Data, qtbot: QtBot):
    __show_dialog(adhoc_erase_dialog_controller, adhoc_erase_dialog_view, dialog_params_factory, qtbot, td)
...
def __show_dialog(controller: AdhocEraseDialogController, view: AdhocEraseDialogView,
                  dialog_params_factory: DialogParamsFactory, qtbot: QtBot, td: Data):
