    ...
    def cases() -> list[Case]:
        return [
            ...
            Case("Stop words: an",
                 ...
                 '<b class="cross-field-highlighter">Automobile</b> was overtaking a slower vehicle.'),
            Case("Short words: should not highlight 'Measure' (TODO fix)",
                 'mesh',
                 "Measure and mark the mesh size.",
                 '<b class="cross-field-highlighter">Measure</b> and mark the <b class="cross-field-highlighter">mesh</b> size.',
