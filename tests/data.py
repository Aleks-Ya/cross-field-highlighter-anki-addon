...
class Data:
    ...
    def cases() -> list[Case]:
        return [
            ...
            Case("Special symbols: hyphen, em dash",
                 'rally',
                 'rally-rally—rally',
                 '<b class="cross-field-highlighter">rally</b>-<b class="cross-field-highlighter">rally</b>—<b class="cross-field-highlighter">rally</b>'),
            Case("Thai language",
                 'ดี',
