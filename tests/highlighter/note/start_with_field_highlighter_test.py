...
def test_cases_space_delimited(start_with_field_highlighter: StartWithFieldHighlighter, td: Data,
                               bold_format: HighlightFormat):
    space_delimited_language: bool = True
    __highlight_erase(bold_format, space_delimited_language, start_with_field_highlighter, td)


def test_cases_non_space_delimited(start_with_field_highlighter: StartWithFieldHighlighter, td: Data,
                                   bold_format: HighlightFormat):
...
def __highlight_erase(bold_format: HighlightFormat, space_delimited_language: bool,
                      start_with_field_highlighter: StartWithFieldHighlighter, td: Data):
    for case in td.cases():
        ...
        # Highlight 1st time
        highlight_result_1: FieldHighlightResult = start_with_field_highlighter.highlight(
        ...
        # Highlight again
        highlight_result_2: FieldHighlightResult = start_with_field_highlighter.highlight(
            note, DefaultFields.basic_front, DefaultFields.basic_back, stop_words, space_delimited_language,
            bold_format)
        ...
        # Erase
        erase_result: NoteFieldEraseResult = start_with_field_highlighter.erase(note, DefaultFields.basic_back)
